 ...
 * Use the [CompleteIntroductionFragment.newInstance] factory method to
...
class CompleteIntroductionFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment CompleteIntroductionFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CompleteIntroductionFragment().apply {
